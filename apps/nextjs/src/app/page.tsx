          ...
          <div className="container mx-auto px-4 py-20">
            <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 text-center">
              ...
              <p className="text-lg text-muted-foreground">
                Discover curated collections, trending pieces, and exclusive
                drops &mdash; all in one place.
              </p>
              <div className="flex flex-wrap items-center justify-center gap-3">
                <Link
                  href="/products"
                  className="rounded-lg bg-primary px-6 py-3 text-primary-foreground transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                >
                  Shop Now
                </Link>
                <Link
                  href="#categories"
                  className="rounded-lg border px-6 py-3 text-foreground transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                >
                  Browse Categories
                </Link>
              </div>
